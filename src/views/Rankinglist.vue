<template>
    <div class="!px-[3vw] bg-[#F7F9FC]">
        ...
        <div class="!mt-[8vw]">
            ...
            <div
            class="h-[40vw] bg-[#fff] rounded-xl !mb-[5vw] !p-[4vw]" 
        ...
        <div class="bg-[#F7F9FC] !mt-[4vw]">
            ...
            <div class="!mt-[8vw]">
                ...
                <div class="flex flex-wrap">
                    <img 
                    class="w-[28vw] h-[28vw] !mr-[3.3vw] !mt-[4vw] rounded-lg"
                    v-for="item in AllListSummary?.slice(0,11)" :key="item.id"
            ...
            <div class="!mt-[8vw]">
                ...
                <div class="flex flex-wrap">
                    <img 
                    class="w-[28vw] h-[28vw] !mr-[3.3vw] !mt-[4vw] rounded-lg"
                    v-for="item in AllListSummary?.slice(11,19)" :key="item.id"
                    :src="item.coverImgUrl">
                </div>
            </div>
            <!-- 全球榜 -->
            <div class="!mt-[8vw]">
                ...
                <div class="flex flex-wrap">
                    <img 
                    class="w-[28vw] h-[28vw] !mr-[3.3vw] !mt-[4vw] rounded-lg"
                    v-for="item in AllListSummary?.slice(19,25)" :key="item.id"
                    :src="item.coverImgUrl">
                </div>
            </div>
            <!-- 语种榜 -->
            <div class="!mt-[8vw]">
                ...
                <div class="flex flex-wrap">
                    <img 
                    class="w-[28vw] h-[28vw] !mr-[3.3vw] !mt-[4vw] rounded-lg"
                    v-for="item in AllListSummary?.slice(25,32)" :key="item.id"
                    :src="item.coverImgUrl">
                </div>
            </div>
            <!-- 特色榜 -->
            <div class="!mt-[8vw]">
                ...
                <div class="flex flex-wrap">
                    <img 
                    class="w-[28vw] h-[28vw] !mr-[3.3vw] !mt-[4vw] rounded-lg"
                    v-for="item in AllListSummary?.slice(32,38)" :key="item.id"
                    :src="item.coverImgUrl">
                </div>
            </div>
        </div>
...
import {List} from "@/service/service";
